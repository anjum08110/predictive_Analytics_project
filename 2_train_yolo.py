...
# train - failed
# train2 - ERROR WITH LABELS -no rotation, model.train(data="dataset-no-rotation.yaml", epochs=100, imgsz=640)
# train3 - ERROR WITH LABELS - rotated, model.train(data="dataset-rotated.yaml", epochs=100, imgsz=640)